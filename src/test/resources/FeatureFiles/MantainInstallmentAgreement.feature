Feature: [SUC:08-06]-Mantain installment agreement
  ...
  @SUC:08-06 @UAT_M8-08-06-05 @backoffice @boom
  Scenario: UAT_M8-08-03-05-Verify the process of abandon cancel
    ...
    Then Search for case using tin "" and agreement number "IA000000070"
  ...
  @SUC:08-06 @UAT_M8-08-06-06 @backoffice @boom
  ...
  @SUC:08-06 @UAT_M8-08-06-02 @backoffice @boom
